...
ALTER TABLE contact_transactions ADD COLUMN transaction_type TEXT;
ALTER TABLE contact_transactions ALTER COLUMN currency TYPE TEXT;
ALTER TABLE contact_transaction ADD COLUMN last_notified TIMESTAMP(0) DEFAULT now()
